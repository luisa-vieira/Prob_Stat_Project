...
for i in range(num_graphs):
    u = u_values[i]
    v = v_values[i]
    time_points,  population_X1_sizes, population_Y1_sizes, population_X2_sizes, population_Y2_sizes, population_X3_sizes, population_Y3_sizes = birth_death_migration_process(
        X1_0, X2_0, X3_0, Y1_0, Y2_0, Y3_0, a10, a11, a12, a20, a21, u, v, total_time)
        
    ax = axes[i]
    ax.plot(time_points, population_X1_sizes, label='Prey 1')
    ax.plot(time_points, population_Y1_sizes, label='Predator 1')
    ax.plot(time_points, population_X2_sizes, label='Prey 2')
    ax.plot(time_points, population_Y2_sizes, label='Predator 2')
    ax.plot(time_points, population_X3_sizes, label='Prey 3')
    ax.plot(time_points, population_Y3_sizes, label='Predator 3')
    ax.set_xlabel('Time')
